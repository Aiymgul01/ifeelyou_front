...
//         const res = await fetch(`http://localhost:5001/api/game-items?type=${type}`);
...
//           await fetch('http://localhost:5001/api/users/progress', {
//             method: 'POST',
...
//   // 5. Обработчики кнопок на экранах ошибок
//   const handleRetry = () => {
//     setUserInput('');
//     setStatus('playing'); // Возвращаемся к той же букве
//   };

//   const handleNextAfterFail = () => {
//     goToNextItem(); // 3 ошибки - пропускаем слово
//   };
...
//       <button onClick={handleRetry} className="bg-brand-purple hover:bg-brand-dark text-white font-bold py-4 px-12 rounded-full text-xl flex items-center gap-3 shadow-md transition-transform hover:scale-105 z-10">
//         Қайталау 🚀
//       </button>
//     </div>
//   );
...
//       <button onClick={handleNextAfterFail} className="bg-brand-purple hover:bg-brand-dark text-white font-bold py-4 px-12 rounded-full text-xl flex items-center gap-3 shadow-md transition-transform hover:scale-105 z-10">
//         Қайталау 🚀
//       </button>
//     </div>
//   );
...
//       <h2 className="text-6xl font-bold text-brand-purple mb-2 uppercase">Сен өте</h2>
//       <h2 className="text-6xl font-bold text-brand-purple mb-12 uppercase">Мықтысың!</h2>
//       <button onClick={() => setStatus('stage_completed')} className="bg-brand-purple hover:bg-brand-dark text-white font-bold py-4 px-16 rounded-full text-xl flex items-center gap-3">
//         Юху 🚀
//       </button>
//     </div>
//   );
