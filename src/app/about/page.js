...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-10 py-10 animate-fade-in">
      ...
      <section
        id="about"
        className="mb-20 flex flex-col md:flex-row gap-10 items-center"
      >
        <div className="flex-1">
          ...
          <p className="text-brand-purple/80 leading-relaxed mb-4">
            Қазақстандағы алғашқы балаларға арналған Брайль жазу жүйесін тез,
            дұрыс және қызықты меңгеруге арналған құрылғы.
          </p>
          <p className="text-brand-purple/80 leading-relaxed">
            Біздің мақсатымыз - білім алу мүмкіндіктерін теңестіру және көру
        ...
        <div className="flex-1 bg-[url('/images/about_us.jpg')] bg-cover bg-center bg-no-repeat opacity-90 rounded-[40px] shadow-lg relative h-64">
          ...
          <div className="absolute bottom-10 left-10 bg-red-300 text-brand-dark font-bold py-2 px-4 rounded-xl rotate-[15deg]">
            Б
          </div>
          <div className="absolute right-10 top-20 bg-brand-yellow text-brand-dark font-bold py-2 px-4 rounded-xl rotate-[5deg]">
            О
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#eef0f8] rounded-3xl p-10 text-center mb-20 shadow-sm border border-indigo-50">
        <h3 className="text-2xl text-brand-purple font-medium leading-relaxed max-w-4xl mx-auto">
          <span className="text-brand-yellow font-bold">Біздің миссиямыз</span>{" "}
          – әр балаға Брайль жазу жүйесін үйренуге теңдей мүмкіндік беру. Ойын
          арқылы оқу процесін жеңілдету.
        </h3>
      </section>
      ...
      <section className="mb-20 text-center">
        <h2 className="text-3xl font-bold text-brand-purple mb-10">
          Жоба мүшелері
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            (
              ...
              <div
                key={i}
                className="bg-white rounded-[30px] p-6 shadow-md hover:shadow-xl transition duration-300 flex flex-col items-center border border-gray-100"
              >
      ...
      <section
        id="contact"
        className="bg-white rounded-[40px] shadow-xl flex flex-col md:flex-row overflow-hidden border border-gray-50"
      >
        ...
        <div className="bg-brand-purple p-12 text-white flex-1 relative overflow-hidden">
          ...
          <h2 className="text-3xl font-bold mb-2 z-10 relative">
            Бізбен байланыс
          </h2>
          <p className="text-indigo-200 mb-10 z-10 relative">
            Қосымша сұрақтарыңыз болса, хабарласыңыз.
          </p>

          <div className="space-y-8 z-10 relative">
            <div className="flex items-center gap-4">
              <div className="bg-white text-brand-yellow w-12 h-12 rounded-full flex items-center justify-center text-xl">
                ✉️
              </div>
              <div>
        ...
        <div className="p-12 flex-1 bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex gap-4">
              <div className="flex-1">
                <label className="text-brand-purple text-sm font-medium mb-2 block">
                  Аты-жөні
                </label>
                <input
                  required
                  type="text"
                  placeholder="Өз атыңызды енгізіңіз"
                  className="w-full bg-[#eef0f8] p-4 rounded-xl text-sm outline-brand-purple"
                  onChange={(e) =>
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                className="w-full bg-[#eef0f8] p-4 rounded-xl text-sm outline-brand-purple resize-none"
                onChange={(e) =>
            ...
            <button
              type="submit"
              className="bg-brand-purple text-white px-8 py-3 rounded-full font-bold hover:bg-brand-dark transition float-right flex items-center gap-2"
            >
              Жіберу ✈️
            </button>
            {status && (
              <p className="text-brand-purple text-sm font-bold mt-4 clear-both">
                {status}
              </p>
            )}
          </form>
